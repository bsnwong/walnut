        ...
        *{{ Form::selectCourse() }}<br/><strong class="tips" id="course_tip"></strong><br/><br/>
        ...
        <div>
            ...
            <div id="answer_type1">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ Form::selectRange('amount', '0', '26')}}<br/>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ Form::textarea('select_options', null, array('placeholder' => '请输入与选项数量对应的选项，以‘|’隔开...'))}}<br/>
            ...
            <div id="answer_type2" style="display: none">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ Form::selectRange('ms_amount', '0', '26')}}<br/>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ Form::textarea('m_select_options', null, array('placeholder' => '请输入与选项数量对应的选项，以‘|’隔开...'))}}<br/>
